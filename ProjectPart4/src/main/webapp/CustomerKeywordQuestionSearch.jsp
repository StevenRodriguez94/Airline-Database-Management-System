...
<html>
	...
	<body>
		...
		try{
			...
			String answers = "select * from questions where question like '%" + keyword + "%';";
			...
			int count = 0;
   			while(rs1.next()){
				...
				if(answer == null){
					out.println("<b>Answer Pending...</b><br><br>");
				}
				else {
   			...
   			if(count == 0){
   				out.println("<b>No Questions that contain the entered keyword have been asked!");
   			}
