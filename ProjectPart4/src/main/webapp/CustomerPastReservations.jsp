...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Past Reservations Page</title>
	</head>
	<body>
		<%
		try{
			...
			query = "select o.*, r.flightKind, r.reservationId from flightTicket t, flightoperation o inner join reservationList r on r.flight1 = o.flightnum "
					+ " where flightDate < CURRENT_DATE() AND t.reservationId = r.reservationId and customerId = '" + user + "' " 
				      + "OR (flightDate = CURRENT_DATE() AND departTime >= CURRENT_TIME() and t.reservationId = r.reservationId "
				      + "and customerId = '" + user + "');";
			...
			if(count == 0){
				out.println("<b>No reservations have been made in the past.</b>");
			}
