...
<html>
	...
	<body>
		...
		try{
			...
			String query = "select o.*, reservationId from reservationList r, flightoperation o where flight1 = flightnum "
					+ "and datediff(flightDate, curdate()) < 3 "
                    + "and datediff(flightDate, curdate()) > 0 group by reservationId";
			...
			if(count == 0){
				out.println("<b>There are no one-way nor round-trip flights available in three days</b>");
			}
