...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Round Trip Flights Page</title>
	</head>
	<body>
		<%
		try{
			...
			String query = "select r.reservationId from reservationList r, flightoperation o where r.flightKind = 'round-trip' and flight1 = flightnum "
					+ "and flightDate = '" + date + "'";
