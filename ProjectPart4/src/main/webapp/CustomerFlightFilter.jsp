...
<html>
	...
	<body>
		...
		try{
			...
			if(filter.equals("airlineId")){
				query = "SELECT reservationId from reservationList r, flightoperation o "
						+ "where flight1 = flightnum and airlineId = '" + data + "';";
			}
 			else if(filter.equals("departTime")) {
				query = "SELECT reservationId from reservationList r, flightoperation o "
						+ "where flight1 = flightnum and departTime = '" + data + "';";
			} 
 			else if(filter.equals("arrivalTime")){
				query = "SELECT reservationId from reservationList where " + filter + " = '" + data + "';";
 			}
			else {
				query = "SELECT reservationId from reservationList where " + filter + " = " + data;
			}
